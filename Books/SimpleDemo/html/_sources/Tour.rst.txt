.. raw:: html
   ...
   <script>ODSA.SETTINGS.MODULE_SECTIONS = ['making-a-book', 'textual-content', 'visualizations', 'exercises', 'binary-search-tree-small-count-exercise'];</script>
...
.. raw:: html
   ...
   <script>ODSA.SETTINGS.DISP_MOD_COMP = true;ODSA.SETTINGS.MODULE_NAME = "Tour";ODSA.SETTINGS.MODULE_LONG_NAME = "OpenDSA: A Guided Tour";ODSA.SETTINGS.MODULE_CHAPTER = "Introduction to OpenDSA for Developers"; ODSA.SETTINGS.BUILD_DATE = "2021-10-24 13:00:15"; ODSA.SETTINGS.BUILD_CMAP = false;JSAV_OPTIONS['lang']='en';JSAV_EXERCISE_OPTIONS['code']='java';</script>
